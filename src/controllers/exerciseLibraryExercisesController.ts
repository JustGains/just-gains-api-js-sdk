...
} from '../models/exerciseUpdateRequest';
import {
...
export class ExerciseLibraryExercisesController extends BaseController {
  /**
  ...
  /**
   * @param body
   * @param localeCode   Locale code to specify the language to return the newly
   *                                                     created exercise in.
   * @return Response from the API call
   */
  async createANewExercise(
    ...
    const mapped = req.prepareArgs({
      body: [body, exerciseUpdateRequestSchema],
      localeCode: [localeCode, optional(string())],
    });
   ...
   * @param localeCode   The locale codes to filter by (e.g., 'en-US', 'es-ES')
   * @return Response from the API call
   */
  async getExerciseTranslations(
    ...
    const mapped = req.prepareArgs({
      exerciseCode: [exerciseCode, string()],
      localeCode: [localeCode, optional(array(string()))],
    });
    req.query('localeCode', mapped.localeCode);
