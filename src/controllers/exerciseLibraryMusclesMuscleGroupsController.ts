...
export class ExerciseLibraryMusclesMuscleGroupsController extends BaseController {
  /**
   ...
   * @param muscleGroupCode The unique code of the muscle group
   * @param body
   * @param localeCodes     The array of locales for the instructions (e.g., 'en-US', 'es-
   *                                                    ES')
   * @return Response from the API call
   */
