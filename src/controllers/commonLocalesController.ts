...
import {
  LocaleListResponse,
  localeListResponseSchema,
} from '../models/localeListResponse';
import { LocaleResponse, localeResponseSchema } from '../models/localeResponse';
import { boolean, string } from '../schema';
import { BaseController } from './baseController';

export class CommonLocalesController extends BaseController {
  /**
  ...
  async getLocales(
  ...
  ): Promise<ApiResponse<LocaleListResponse>> {
    ...
    return req.callAsJson(localeListResponseSchema, requestOptions);
  }
