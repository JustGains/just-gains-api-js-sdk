...
import { WorkoutImage, workoutImageSchema } from './workoutImage';
...
export const workoutTableDataSchema: Schema<WorkoutTableData> = object({
  workoutId: ['workoutId', optional(number())],
  workoutTitle: ['workoutTitle', optional(string())],
  workoutImage: ['workoutImage', optional(lazy(() => workoutImageSchema))],
