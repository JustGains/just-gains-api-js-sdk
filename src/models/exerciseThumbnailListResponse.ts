...
export interface ExerciseThumbnailListResponse {
...
export const exerciseThumbnailListResponseSchema: Schema<ExerciseThumbnailListResponse> = object(
  {
    status: ['status', string()],
    message: ['message', string()],
    data: ['data', array(lazy(() => exerciseThumbnailSchema))],
  }
);
