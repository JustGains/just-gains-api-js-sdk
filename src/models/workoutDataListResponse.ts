...
export interface WorkoutDataListResponse {
...
export const workoutDataListResponseSchema: Schema<WorkoutDataListResponse> = object(
  {
    status: ['status', string()],
    message: ['message', string()],
    data: ['data', array(lazy(() => workoutDataSchema))],
  }
);
