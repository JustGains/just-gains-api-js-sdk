...
function createConfigurationFromEnvironment(): Partial<Configuration> {
  ...
  const environment = process.env.WORKOUT_CREATOR_API_LIB_ENVIRONMENT;
  const timeout = process.env.WORKOUT_CREATOR_API_LIB_TIMEOUT;
  const accessToken = process.env.WORKOUT_CREATOR_API_LIB_ACCESS_TOKEN;
